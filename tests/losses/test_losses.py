...
class TestLosses(absltest.TestCase):
    def test_0_loss_none_includes(self):
        ...
        reduces = 'none'
        flaxsr.losses.get_loss_wrapper(names, weights, reduces)
    ...
    def test_1_loss_calculation(self):
        ...
        loss_wrapper = flaxsr.losses.get_loss_wrapper(names, weights, reduces)
        hr = jnp.ones((1, 3, 3, 3))
        ...
        loss = flaxsr.losses.compute_loss(hr, sr, loss_wrapper, mask=mask)
